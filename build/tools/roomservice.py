...
custom_default_revision = "exthm-12.0"
...
exthm_manifest = ".repo/manifests/exthm.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    exthmm = load_manifest(exthm_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(exthmm, repo_target) != None:
            existing_m_project = exists_in_tree(exthmm, repo_target)
