...
ifeq ($(EXTHM_BUILDTYPE), RELEASE)
    ...
    ifeq ($(EXTHM_VERSION_MAINTENANCE),0)
        ifeq ($(EXTHM_VERSION_APPEND_TIME_OF_DAY),true)
            EXTHM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d_%H%M%S)-$(EXTHM_COMPILERTYPE)-$(EXTHM_BUILDTYPE)$(EXTHM_EXTRAVERSION)-$(EXTHM_BUILD)-$(EXTHM_VERSION_GAPPS)
        else
            EXTHM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(EXTHM_COMPILERTYPE)-$(EXTHM_BUILDTYPE)$(EXTHM_EXTRAVERSION)-$(EXTHM_BUILD)-$(EXTHM_VERSION_GAPPS)
        endif
    else
        ifeq ($(EXTHM_VERSION_APPEND_TIME_OF_DAY),true)
            EXTHM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(EXTHM_VERSION_MAINTENANCE)-$(shell date +%Y%m%d_%H%M%S)-$(EXTHM_COMPILERTYPE)-$(EXTHM_BUILDTYPE)$(EXTHM_EXTRAVERSION)-$(EXTHM_BUILD)-$(EXTHM_VERSION_GAPPS)
        else
            EXTHM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(EXTHM_VERSION_MAINTENANCE)-$(shell date +%Y%m%d)-$(EXTHM_COMPILERTYPE)-$(EXTHM_BUILDTYPE)$(EXTHM_EXTRAVERSION)-$(EXTHM_BUILD)-$(EXTHM_VERSION_GAPPS)
        endif
    endif
endif
